...
var _user$project$LayoutExample$tabs = function (model) {
	return {
		ctor: '::',
		_0: _elm_lang$html$Html$text('Tab1'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text('Tab2'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text('Tab3'),
				_1: {ctor: '[]'}
			}
		}
	};
};
var _user$project$LayoutExample$drawer = function (model) {
	return {
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(model.appName),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
...
var _user$project$LayoutExample$header = function (model) {
	return A2(
		_debois$elm_mdl$Material_Layout$row,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Color$background(
				A2(_debois$elm_mdl$Material_Color$color, model.color, _debois$elm_mdl$Material_Color$S500)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$LayoutExample$body2 = function (model) {
	return A2(
...
var _user$project$LayoutExample$body = function (model) {
	var body = A2(_elm_lang$core$String$repeat, 30, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse at justo augue. ');
	var bodyCells = A2(
	...
	var title = A2(
		...
		},
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(model.tabName),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
	return A2(
		_debois$elm_mdl$Material_Grid$grid,
		boxed,
		{ctor: '::', _0: title, _1: bodyCells});
};
var _user$project$LayoutExample$model = {message: 'Hello World', appName: 'Sample', tabName: 'Tab1', color: _debois$elm_mdl$Material_Color$Indigo, mdl: _debois$elm_mdl$Material$model};
var _user$project$LayoutExample$Model = F5(
	function (a, b, c, d, e) {
		return {message: a, appName: b, tabName: c, color: d, mdl: e};
	});
var _user$project$LayoutExample$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$LayoutExample$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A3(_debois$elm_mdl$Material$update, _user$project$LayoutExample$Mdl, _p0._0, model);
	});
var _user$project$LayoutExample$layout = function (model) {
	return _debois$elm_mdl$Material_Scheme$top(
		A4(
			_debois$elm_mdl$Material_Layout$render,
			_user$project$LayoutExample$Mdl,
			model.mdl,
			{
				ctor: '::',
			...
			},
			{
				header: {
					ctor: '::',
					_0: _user$project$LayoutExample$header(model),
					_1: {ctor: '[]'}
				},
				drawer: _user$project$LayoutExample$drawer(model),
				tabs: {
					ctor: '_Tuple2',
					_0: _user$project$LayoutExample$tabs(model),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Color$background(
							A2(_debois$elm_mdl$Material_Color$color, model.color, _debois$elm_mdl$Material_Color$S400)),
						_1: {ctor: '[]'}
					}
				},
				main: {
					ctor: '::',
					_0: _user$project$LayoutExample$body(model),
					_1: {ctor: '[]'}
				}
			}));
};
var _user$project$LayoutExample$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$LayoutExample$model, _1: _elm_lang$core$Platform_Cmd$none},
		view: _user$project$LayoutExample$layout,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		update: _user$project$LayoutExample$update
	})();

var Elm = {};
Elm['LayoutExample'] = Elm['LayoutExample'] || {};
if (typeof _user$project$LayoutExample$main !== 'undefined') {
    _user$project$LayoutExample$main(Elm['LayoutExample'], 'LayoutExample', undefined);
}
